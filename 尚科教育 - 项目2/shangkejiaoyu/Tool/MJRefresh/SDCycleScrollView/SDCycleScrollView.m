...
/*
 _lwdPageControl = [[LWDPageControl alloc] initWithFrame:CGRectMake(0, kHeight - 40, kWidth, 40) indicatorMargin:5.f indicatorWidth:10.f currentIndicatorWidth:20.f indicatorHeight:10];
 _lwdPageControl.numberOfPages = _imagePathsGroup.count;
 _lwdPageControl.backgroundColor = [UIColor redColor];
 //    _lwdPageControl.scrollView = self.collectionView;
 [self addSubview:_lwdPageControl];

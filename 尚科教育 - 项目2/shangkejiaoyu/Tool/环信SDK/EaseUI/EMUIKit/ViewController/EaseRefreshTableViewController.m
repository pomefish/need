...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight - kScreenWidth *9/16 - 64) style:self.style];
...
- (void)setShowRefreshHeader:(BOOL)showRefreshHeader
{
    if (_showRefreshHeader != showRefreshHeader) {
        ...
        if (_showRefreshHeader) {
            ...
            self.tableView.header.accessibilityIdentifier = @"refresh_header";
            //            header.updatedTimeHidden = YES;
        }
        else{
            [self.tableView setHeader:nil];
        }
    }
}
...
- (void)setShowRefreshFooter:(BOOL)showRefreshFooter
{
    if (_showRefreshFooter != showRefreshFooter) {
        ...
        if (_showRefreshFooter) {
            ...
            self.tableView.footer.accessibilityIdentifier = @"refresh_footer";
        }
        else{
            
            [self.tableView setFooter:nil];
        }
    }
}

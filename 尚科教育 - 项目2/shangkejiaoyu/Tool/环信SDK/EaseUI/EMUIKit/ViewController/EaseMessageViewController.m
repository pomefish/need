...
//    [[NSUserDefaults standardUserDefaults] setObject:dic[@"name"] forKey:@"nickname"];
//    [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%@%@",HTTP,dic[@"hearder"]] forKey:@"avatar"];
    NSLog(@"------------------%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"nickname"]);
    NSLog(@"--------type----------%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"type"]);
    ...
    message.ext = @{
                    @"from_head_icon" : [[NSUserDefaults standardUserDefaults] objectForKey:@"avatar"],
                    @"from_username" : [[NSUserDefaults standardUserDefaults] objectForKey:@"nickname"],
                    @"to_head_icon" : [[NSUserDefaults standardUserDefaults] objectForKey:@"to_head_icon"],
                    @"to_username" : [[NSUserDefaults standardUserDefaults] objectForKey:@"to_username"],

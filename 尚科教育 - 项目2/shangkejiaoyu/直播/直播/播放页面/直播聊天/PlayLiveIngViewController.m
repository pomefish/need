...
@interface PlayLiveIngViewController ()<UIAlertViewDelegate,EMClientDelegate>
{
...
@implementation PlayLiveIngViewController
...
- (void)viewDidLoad {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"2222" forKey:@"to_head_icon"];
    [[NSUserDefaults standardUserDefaults] setObject:@"333333" forKey:@"to_username"];
                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    if (model.isSender) {
        if ([message.ext[@"type"] isEqualToString:@"1"]) {
            model.avatarImage = [UIImage imageNamed:@"personalLogo"];
            model.nickname = @"管理员";
        }else {
            if ([message.ext[@"from_head_icon"] isEqualToString:@"http://api.mingtaokeji.com<null>"] || message.ext[@"from_head_icon"] == nil || [message.ext[@"from_head_icon"] isEqualToString:@"http://api.mingtaokeji.com"]) {
                model.avatarImage = [UIImage imageNamed:@"tx"];
            }else {
                model.avatarURLPath = [[NSUserDefaults standardUserDefaults] objectForKey:@"avatar"];
            }
//        model.avatarURLPath = ;
        model.nickname = [[NSUserDefaults standardUserDefaults] objectForKey:@"nickname"];
        }
//        EPLog(@"-------model.type-------%@",model.type);
    } else {
        ...
        if ([message.ext[@"type"] isEqualToString:@"1"]) {
            ...
            if ([message.ext[@"from_head_icon"] isEqualToString:@"http://api.mingtaokeji.com<null>"] || message.ext[@"from_head_icon"] == nil || [message.ext[@"from_head_icon"] isEqualToString:@"http://api.mingtaokeji.com"]) {
                ...
                model.avatarURLPath = message.ext[@"from_head_icon"];
            }
            model.nickname = message.ext[@"from_username"];
        }
    }
